...
@Controller
public class UserController {//放置整个跟用户信息相关的
	...
	public String registerPage(Model model) {
		...
		model.addAttribute("fieldList", fieldList);//把所有的专业放入到注册页面中
		return "register";
	}
	...
	Message userRegister(@RequestBody User user) {
		...
		String resultPassword = passwordEncoder.encode(password);//对密码加密
	...
	public String settingPage(Model model) {//预先填置整个表
