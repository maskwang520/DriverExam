					...
					<div class="col-md-12">
						<div class="flexslider">
							<div class="flex-caption">
								<!-- Left column -->
								<div class="col-l">
									<p style="text-indent:2em;">DriverExam基于java web的驾校考试系统，采用bootstrap,spring，spring mvc,mybatis，spring security等相关核心技术，构建一个让用户可以在该应用上练习驾校科目一的试题，帮助广大用户提升考试成功率</p>
										     ...
										     <div class="modal-body">
										     	<ul>
										     		<c:forEach items="${wrongKnowledgeMap }" var="item" >
										     			<li><span class="point-name"> ${item.key }</span> [共<span class="question-number-3"><c:forEach items="${item.value }" var="v">${v.value/2 }</c:forEach> </span>题]
